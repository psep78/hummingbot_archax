...
class ArchaxAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def _order_book_snapshot(self, trading_pair: str) -> OrderBookMessage:
        ...
        snapshot_msg: OrderBookMessage = ArchaxOrderBook.snapshot_message_from_exchange_rest(
            snapshot,
            snapshot_timestamp,
    ...
    async def _parse_order_book_diff_message(self, raw_message: Dict[str, Any], message_queue: asyncio.Queue):
        ...
        for diff_message in raw_message["data"]:
            order_book_message: OrderBookMessage = ArchaxOrderBook.diff_message_from_exchange(
